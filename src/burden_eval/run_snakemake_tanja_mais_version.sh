...
#SBATCH --gres=gpu:1
#SBATCH --mail-user=mai.mai@tum.de,tanja.pock@p2-it.de,merit.back@tum.de
...
snakemake --snakefile /data/nasif12/home_if12/l_mai/sc-genetics/src/burden_eval/Snakefile --cores 1