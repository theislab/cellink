    ...
    *,
    ...
    if accession_col is not None:
        ...
        if ensembl_like:
            ...
            mask = spec_upper.isin(overlap)  # pd.Index.isin() returns numpy bool array
            specificity_df = specificity_df.loc[mask].copy()
            specificity_df.index = spec_upper[mask].values  # normalized
