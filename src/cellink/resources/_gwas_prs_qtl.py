...
def get_gwas_catalog_study_summary_stats(accession_id, dest=None, return_path=False, **params):
    if not dest:
...
def get_pgs_catalog_score_file(pgs_id, dest=None, return_path=False, **params):
...
def get_eqtl_catalog_dataset_associations(dataset_id, data_home=None, refresh=False, return_path=False, **params):
    data_home = get_data_home(data_home)
    dest = data_home / f"{dataset_id}_eqtl_associations.parquet"
