...
python /data/nasif12/home_if12/l_mai/sc-genetics/src/burden_eval/run_burden_testing.py -c 22 -i "/data/ceph/hdd/project/node_09/sys_gen_students/2024_2025/project04_rare_variant_sc/input_data/filter_vcf_r08/chr22.dose.filtered.R2_0.8.vcz" -o  "/s/project/sys_gen_students/2024_2025/project04_rare_variant_sc/test_output/chr22_test.pkl"